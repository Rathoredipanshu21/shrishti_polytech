...
<body class="bg-gray-50 overflow-x-hidden w-full">
    ...
    <div class="bg-[#1e90b8] py-12 md:py-20 text-center relative overflow-hidden w-full">
        ...
        <div class="relative z-10 container mx-auto px-4 sm:px-6" data-aos="zoom-in">
            ...
            <p class="text-gray-100 text-base sm:text-lg max-w-2xl mx-auto px-2">Discover our range of advanced water treatment solutions engineered for excellence.</p>
        </div>
    </div>
    ...
    <section class="container mx-auto px-4 sm:px-6 py-12 md:py-16 w-full">
        ...
        <div class="text-center mt-12" data-aos="fade-up" data-aos-delay="100">
            <a href="products" class="inline-flex items-center gap-2 bg-[#1e90b8] text-white px-10 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-[#111] hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
